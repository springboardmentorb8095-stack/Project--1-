...
export default function PublicLayout() {
  ...
  return (
    <div className={`${darkMode ? "dark" : ""} min-h-screen flex flex-col bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-100 overflow-hidden relative`}>
      {/* ===== NAVBAR ===== */}
      <nav className="bg-white dark:bg-gray-800 shadow-md fixed top-0 left-0 right-0 z-30">
        <div className="max-w-7xl mx-auto  py-4 flex justify-between items-center">
          ...
          <div className="space-x-3 flex items-center">
            <button
              ...
              className="px-3 py-2 rounded-md bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 transition"
            >
              {darkMode ? "☀️" : "🌙"}
            </button>
            <button
              onClick={() => setPanel("login")}
              className="px-4 py-2 rounded-md font-medium text-gray-700 dark:text-gray-200 hover:text-indigo-500 transition"
            >
              Login
            </button>
            <button
          ...
          <>
            ...
            <section className="relative w-full py-32 text-center">
              ...
              <div className="relative max-w-6xl mx-auto px-6">
                <h1 className="text-4xl md:text-5xl font-extrabold mb-6 leading-tight drop-shadow-lg text-white">
                  Connect. Collaborate. Create.
                </h1>
                <p className="text-lg md:text-xl mb-10 max-w-3xl mx-auto text-gray-200/90">
                  TalentLink bridges the gap between top freelancers and visionary clients.
                </p>
                <div className="flex justify-center gap-4">
                  <button
                    onClick={() => setPanel("register")}
                    className="bg-white dark:bg-gray-700 text-indigo-600 dark:text-indigo-300 font-semibold px-8 py-3 rounded-full shadow-lg hover:bg-indigo-50 dark:hover:bg-gray-600 transition transform hover:-translate-y-1"
                  >
                    Get Started
                  </button>
                  <button
                    onClick={() => setPanel("login")}
                    className="border border-white dark:border-gray-400 text-white dark:text-gray-200 font-semibold px-8 py-3 rounded-full hover:bg-white dark:hover:bg-gray-700 hover:text-indigo-600 dark:hover:text-indigo-300 transition transform hover:-translate-y-1"
                  >
                    Login
                  </button>
                </div>
            ...
            {/* Features Section */}
            <section className="py-24 bg-gray-50 dark:bg-gray-800 w-full">
              <div className="max-w-6xl mx-auto px-6 text-center">
                ...
                <div className="grid md:grid-cols-3 gap-10">
                  {[
                    ...
                    <div
                      key={i}
                      className="bg-white dark:bg-gray-900 p-10 rounded-2xl shadow-xl hover:shadow-2xl transition transform hover:-translate-y-2"
                    >
                      <div className="flex flex-col items-center">
                        {feature.icon}
                        <h3 className="text-xl md:text-2xl font-semibold mb-2 text-gray-900 dark:text-white">{feature.title}</h3>
            ...
            <section className="py-20 w-full bg-gray-200 dark:bg-gray-700">
              <div className="max-w-6xl mx-auto px-6">
                <div className="flex flex-col md:flex-row gap-8 items-stretch">
                  <div
                    onClick={() => setShowProjects(true)}
                    className="flex-1 cursor-pointer bg-indigo-500 text-white rounded-2xl p-12 shadow-lg hover:shadow-2xl transition transform hover:-translate-y-2 flex flex-col justify-center items-center text-center relative"
                  >
                    <div className="absolute inset-0 bg-cover bg-center rounded-2xl" style={{ backgroundImage: `url(${explore})` }}></div>
                  </div>
                  <div className="flex-1 bg-white dark:bg-gray-900 rounded-2xl p-12 shadow-lg hover:shadow-xl transition transform hover:-translate-y-1 flex flex-col justify-center">
                    <h3 className="text-2xl md:text-3xl font-bold mb-4 text-gray-800 dark:text-gray-100">Explore Projects</h3>
            ...
            {/* How It Works */}
            <section className="py-24 bg-white dark:bg-gray-800 w-full">
              <div className="max-w-6xl mx-auto px-6 text-center">
                ...
                <div className="grid md:grid-cols-3 gap-12 text-left">
                  {[
                    ...
                    <div
                      key={idx}
                      className="p-8 border border-gray-100 dark:border-gray-700 rounded-2xl shadow-md hover:shadow-xl transition transform hover:-translate-y-1"
                    >
                      <div className="flex flex-col items-start">
                        {item.icon}
                        <h3 className="text-xl md:text-2xl font-semibold mb-2 text-gray-900 dark:text-white">{item.title}</h3>
      ...
      {/* ===== RIGHT PANEL ===== */}
      <div
        className={`fixed top-0 right-0 h-full bg-white dark:bg-gray-900 shadow-2xl w-full md:w-[400px] z-40 transform transition-transform duration-500 ${
          panel ? "translate-x-0" : "translate-x-full"
        }`}
      >
        <div className="flex justify-between items-center p-4 border-b border-gray-200 dark:border-gray-700">
          <h2 className="text-xl font-semibold text-gray-700 dark:text-gray-200 capitalize">{panel}</h2>
          <button onClick={closePanel} className="text-gray-500 dark:text-gray-300 hover:text-gray-800 dark:hover:text-white text-xl">
            ✕
          </button>
        </div>
      ...
      {/* Footer */}
      <footer className="bg-gray-700 dark:bg-gray-800 text-gray-300 dark:text-gray-400 py-12 mt-auto">
        <div className="max-w-7xl mx-auto px-6 text-center text-sm">
          <h3 className="text-lg font-semibold text-white dark:text-gray-100 mb-3">TalentLink</h3>
          ...
          <div className="text-gray-500 dark:text-gray-400 text-sm border-t border-gray-700 dark:border-gray-600 pt-4">
