    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('freelancer', 'Freelancer'), ('client', 'Client')], default='freelancer', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skills_required', models.ManyToManyField(blank=True, to='api.skill')),
            ],
        ),
        migrations.CreateModel(
            name='Contract',
