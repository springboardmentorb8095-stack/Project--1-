...
function RegisterPage() {
  ...
  return (
    ...
    >
      <div
        className="card shadow d-flex flex-row overflow-hidden animate__animated animate__fadeInUp"
        style={{
          maxWidth: '900px',
          width: '100%',
          borderRadius: '20px',
      ...
      >
        ...
        <div className="col-md-6 p-5 bg-white">
          <h3 className="text-center mb-2 text-primary">Create Account</h3>
          ...
          <div className="mb-3 animate__animated animate__fadeInRight animate__delay-3s">
          ...
          <button
            className="btn btn-primary w-100 mt-2 animate__animated animate__pulse animate__infinite"
