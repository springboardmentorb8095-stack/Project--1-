  ...
  return (
    <div className={`homepage ${darkMode ? "dark" : "light"}`}>
      ...
      <header className="homepage-header">
        <h1 className="logo">Talent-Link 🌐</h1>
      ...
      <section className="hero">
        <div className="hero-content">
          <h2 className="animated-text">
            Welcome to <span>Talent-Link</span>
          </h2>
          <p>
      ...
      {/* ✅ How It Works (Moved Below Why Choose) */}
      ...
      <section className="cta-section">
        ...
        <p>
          Join thousands of freelancers and clients already working together on <b>Talent-Link</b>.
        </p>
