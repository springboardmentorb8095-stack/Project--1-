...
function FreelancerDashboard() {
  ...
  const handleRestoreFromTrash = (e, projectTitleToRestore, emailToRestore) => {
    ...
    setArchivedProjects(updatedArchivedApps подум);
  ...
  const handleRatingSubmit = (rating) => {
    ...
    pushNotification("Rating Submitted", `You rated the client ${rating} stars for "${currentRatingProject.projectTitle}". project.`, "success");
  };
  ...
  return (
    <div className="dashboard-container">
      ...
      <div className="main-content">
        ...
        {/* ALL ORIGINAL SECTIONS BELOW - UNTOUCHED */}
        {showAppliedList && (
          <>
