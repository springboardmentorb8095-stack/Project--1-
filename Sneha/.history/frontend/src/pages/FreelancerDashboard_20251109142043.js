...
  // 🆕 New States for Profile Dropdown and Account Deletion (Q3, Q5)
...
        </div>
        
        {/* Right Corner: Notification and Profile Icon (Q3) */}
        <div className="nav-right-col">
          
          {/* 🔔 Notification Icon (Existing content) */}
          <div 
...
          {/* 🆕 Profile Icon with Dropdown (Q3 & Q4) */}
          <div 
...
                </div>
                
                {/* c) Account (Q4 & Q5) - Triggers the delete popup */}
                <div 
                  className="dropdown-item" 
                  onClick={() => {
                    setShowProfileDropdown(false);
...
      {/* NOTE: Removed existing sidebar JSX completely as requested (Q1, Q2) */}

      <div className="dashboard-content-area">
        {/* The rest of your content (Applied List, Reports, Trash, etc.) starts here. */}
        {/* ... (Your existing code for rendering content based on states: showAppliedList, showReports, showTrash) ... */}

        {showTrash && (
          <div className="trash-view">
            <h2>🗑️ Trash / Archived Applications</h2>
            {/* ... Trash View JSX ... */}
          </div>
        )}
...
      
      {/* 🆕 Account Delete Confirmation Popup (Q5 & Q6) */}
      {showAccountDeletePopup && (
        <div className="popup-overlay">
          <div className="popup account-delete-popup">
