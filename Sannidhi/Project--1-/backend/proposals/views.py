...
# Freelancer: Update their own proposal
class MyProposalUpdateView(generics.UpdateAPIView):
    serializer_class = ProposalSerializer
    permission_classes = [permissions.IsAuthenticated]
...
# Freelancer: Delete their own proposal
class MyProposalDeleteView(generics.DestroyAPIView):
    permission_classes = [permissions.IsAuthenticated]
