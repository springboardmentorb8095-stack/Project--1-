...
SECRET_KEY = 'django-insecure-sa-1264^hpmx#2bahoqo+cz@owksad9a#t%g41+=9f+nd%aykp'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates'),
                 os.path.join(BASE_DIR, 'venv/Lib/site-packages/crispy_forms/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Define the destination for collected static files
