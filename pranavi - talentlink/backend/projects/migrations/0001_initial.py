    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duration', models.CharField(choices=[('short', 'Short Term (< 1 month)'), ('medium', 'Medium Term (1-3 months)'), ('long', 'Long Term (> 3 months)')], max_length=20)),
                ...
                ('skills_required', models.ManyToManyField(related_name='projects', to='profiles.skill')),
            ],
            options={
                'ordering': ['-created_at'],
            },
